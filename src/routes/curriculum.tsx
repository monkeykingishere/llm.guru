...
const ITEMS: Item[] = [
  ...
  { n: "04", title: "Positional Encoding", desc: "Teaching a permutation-invariant model about order.", icon: ScanLine, status: "soon" },
  { n: "05", title: "Neural Networks", desc: "From a single neuron to billions, with intuition intact.", icon: Network, status: "soon" },
  ...
  { n: "10", title: "Prediction Process", desc: "Watch a generation happen, token by token.", icon: Wand2, status: "soon" },
